...
<tr>
	...
	<input  type="radio" name="Firma" value="Asus" check><b>Asus <U>Цены: <br> от 17364 до 21435</U></b>
	</td>
    <td>
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="Acer" checked><b>Acer <U>Цены: <br> от 15678 до 19315</U></b>
	</td>
    <td>
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="Samsung" checked><b>Samsung <U>Цены: <br> от 22312 до 29999</U></b>
	</td>
    <td>
	<img src="samsung.jpg" align="left" width="220" height="150" hspace="28" style="float: left; margin-right: 5px; margin-bottom: 0px;" alt="SAMSUNG Corporation">
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="HP" checked><b>HP <U>Цены: <br> от 18411 до 21312</U></b>
	</td>
    <td>
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="Sony" checked><b>Sony <U>Цены: <br> от 17482 до 23879</U></b>
	</td>
    <td>
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="Apple" checked><b>Apple <U>Цены: <br> от 30212 до 39218</U></b>
	</td>
    <td>
...
<tr>
    <td>
	<input  type="radio" name=" Firma" value="DELL" check><b>DELL <U>Цены:<br> от 14337 до 16257</U></b>
	</td>
    <td>
...
<p>
<input  type="radio" name="ScreenSize" value="15" checked><b>15 Asus <U>(17364)</U>; Acer <U>(15678)</U>; Samsung <U>(22312)</U>; HP <U>(18411)</U>; Sony<U>(17482)</U>; Apple <U>(30212)</U>; DELL <U>(14337)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="16" checked><b>16 Asus <U>(17671)</U>; Acer <U>(16745)</U>; Samsung <U>(23674)</U>; HP <U>(18719)</U>; Sony<U>(18620)</U>; Apple <U>(30874)</U>; DELL <U>(14687)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="17" checked><b>17 Asus <U>(18235)</U>; Acer <U>(17104)</U>; Samsung <U>(24536)</U>; HP <U>(19543)</U>; Sony<U>(19540)</U>; Apple <U>(32015)</U>; DELL <U>(15006)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="18" checked><b>18 Asus <U>(18843)</U>; Acer <U>(17721)</U>; Samsung <U>(25123)</U>; HP <U>(19984)</U>; Sony<U>(20530)</U>; Apple <U>(33817)</U>; DELL <U>(15218)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="19" checked><b>19 Asus <U>(19279)</U>; Acer <U>(18236)</U>; Samsung <U>(26555)</U>; HP <U>(20090)</U>; Sony<U>(21463)</U>; Apple <U>(35515)</U>; DELL <U>(15612)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="20" checked><b>20 Asus <U>(20023)</U>; Acer <U>(18987)</U>; Samsung <U>(28100)</U>; HP <U>(20672)</U>; Sony<U>(22365)</U>; Apple <U>(37756)</U>; DELL <U>(16019)</U>;</b><br>
<input  type="radio" name="ScreenSize" value="21" checked><b>21 Asus <U>(21435)</U>; Acer <U>(19315)</U>; Samsung <U>(29999)</U>; HP <U>(21312)</U>; Sony<U>(23879)</U>; Apple <U>(39218)</U>; DELL <U>(16257)</U>.</b><br>
</p>
...
<input type="radio" value="Чёрный" id="chek1" onclick="checkCheck(this)" name="colour" />Черный<br>
<input type="radio" value="Белый" id="chek1" onclick="checkCheck(this)" name="colour" />Белый<br>
<input type="radio" value="Металик" id="chek1" onclick="checkCheck(this)" name="colour" />Металик<br>
<input type="radio" value="Красный" id="chek1" onclick="checkCheck(this)" name="colour" />Красный<br>
<input type="radio" value="Желтый" id="chek1" onclick="checkCheck(this)" name="colour" />Желтый<br>
<input type="radio" value="Фиолетовый" id="chek1" onclick="checkCheck(this)" name="colour" />Фиолетовый<br>
<input type="radio" value="Зелёный" id="chek1" onclick="checkCheck(this)" name="colour" />Зеленый<br>
<input type="radio" value="Синий" id="chek1" onclick="checkCheck(this)" name="colour" />Синий<br>
